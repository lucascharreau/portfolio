...
(function () {
  ...
  var CV_I18N = {
    fr: {
      ...
      s1p: 'Cliquez sur une expérience pour le détail des missions.',
      s2e: '02 — Formation', s2t: 'Formation académique',
      s3e: '03 — Compétences', s3t: 'Compétences clés',
      s3p: 'Théorie, stratégie, outils',
    ...
    en: {
      ...
      s1p: 'Click any role to see the missions in detail.',
      s2e: '02 — Education', s2t: 'Academic background',
      s3e: '03 — Skills', s3t: 'Core skills',
      s3p: 'Theory, strategy, tools',
